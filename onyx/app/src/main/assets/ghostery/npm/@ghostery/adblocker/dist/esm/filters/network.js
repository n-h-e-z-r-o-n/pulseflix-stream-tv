...
import { fastHash, setBit, findLastIndexOfUnescapedCharacter, getBit, clearBit, hasUnicode, bitCount, tokenizeWithWildcardsInPlace, tokenizeInPlace, tokenizeRegexInPlace, isDigit, isAlpha, HASH_INTERNAL_MULT, HASH_SEED } from '../utils.js';
...
var NETWORK_FILTER_OPTIONAL_PARTS_MASK;
(function (NETWORK_FILTER_OPTIONAL_PARTS_MASK) {
    NETWORK_FILTER_OPTIONAL_PARTS_MASK[NETWORK_FILTER_OPTIONAL_PARTS_MASK["hasFilter"] = 1] = "hasFilter";
    NETWORK_FILTER_OPTIONAL_PARTS_MASK[NETWORK_FILTER_OPTIONAL_PARTS_MASK["hasHostname"] = 2] = "hasHostname";
    NETWORK_FILTER_OPTIONAL_PARTS_MASK[NETWORK_FILTER_OPTIONAL_PARTS_MASK["hasDomains"] = 4] = "hasDomains";
    NETWORK_FILTER_OPTIONAL_PARTS_MASK[NETWORK_FILTER_OPTIONAL_PARTS_MASK["hasRawLine"] = 8] = "hasRawLine";
    NETWORK_FILTER_OPTIONAL_PARTS_MASK[NETWORK_FILTER_OPTIONAL_PARTS_MASK["hasDenyallow"] = 16] = "hasDenyallow";
    NETWORK_FILTER_OPTIONAL_PARTS_MASK[NETWORK_FILTER_OPTIONAL_PARTS_MASK["hasOptionValue"] = 32] = "hasOptionValue";
    NETWORK_FILTER_OPTIONAL_PARTS_MASK[NETWORK_FILTER_OPTIONAL_PARTS_MASK["isCaseSensitive"] = 64] = "isCaseSensitive";
...
class NetworkFilter {
    static parse(line, debug = false) {
        ...
        if (filterIndexEnd - filterIndexStart >= 2 &&
            ...
            try {
                compileRegex(filter, false /* isLeftAnchor */, false /* isRightAnchor */, true /* isFullRegex */, isCaseSensitive);
            }
            catch (ex) {
        ...
        if (this.regex === undefined) {
            this.regex =
                this.filter !== undefined && this.isRegex()
                    ? compileRegex(this.filter, this.isLeftAnchor(), this.isRightAnchor(), this.isFullRegex(), this.isCaseSensitive === true)
                    : MATCH_ALL;
        }
        return this.regex;
    }
...
export { NETWORK_FILTER_MASK, NETWORK_FILTER_OPTIONAL_PARTS_MASK, NetworkFilter as default, isAnchoredByHostname, replaceOptionValueToRegexp };
