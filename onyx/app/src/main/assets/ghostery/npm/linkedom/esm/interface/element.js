...
import { ELEMENT_NODE, TEXT_NODE, BLOCK_ELEMENTS, CDATA_SECTION_NODE, ATTRIBUTE_NODE, COMMENT_NODE, NODE_END, SVG_NAMESPACE } from '../shared/constants.js';
import { stringAttribute, numericAttribute, removeAttribute, setAttribute } from '../shared/attributes.js';
import { CLASS_LIST, DATASET, STYLE, END, NEXT, PREV, START, MIME } from '../shared/symbols.js';
import { String as $String, localCase, ignoreCase, htmlToFragment, knownAdjacent } from '../shared/utils.js';
