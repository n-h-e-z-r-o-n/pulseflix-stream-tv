...
import { DOCUMENT_NODE, DOCUMENT_TYPE_NODE, DOCUMENT_FRAGMENT_NODE, ELEMENT_NODE, SVG_NAMESPACE } from '../shared/constants.js';
import { CUSTOM_ELEMENTS, MUTATION_OBSERVER, MIME, DOCTYPE, DOM_PARSER, GLOBALS, IMAGE, UPGRADE, EVENT_TARGET, NEXT, END } from '../shared/symbols.js';
...
import { assign, setPrototypeOf, create, defineProperties } from '../shared/object.js';
...
import { EventTarget as DOMEventTarget } from './event-target.js';
