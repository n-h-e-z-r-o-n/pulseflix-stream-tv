...
class ListItemsParser {
     ...
     */
    static parse(raw, options = defaultParserOptions, baseOffset = 0, separator = COMMA, type = ListItemNodeType.Unknown) {
        // Function body here
        const rawListItems = [];
        let offset = 0;
...
export { LIST_PARSE_ERROR_PREFIX, ListItemsParser };
