...
import { getEntry, invalidate, getEntries, invalidateAll, get as get$1, assert, sync as sync$1, getCurrentValue } from './cache.js';
...
function syncCache(config, id, model, invalidate = true) {
  sync$1(config, id, invalidate ? resolveWithInvalidate : resolve, model);
  return model;
}
  ...
  return {
    ...
    list:
      ...
      function list(id) {
        ...
        const result = [];
        for (const { key, value } of getEntries(config)) {
        ...
        case "function":
          return (model) => {
            Object.defineProperty(model, key, {
              get() {
                return get$1(this, key, () => defaultValue(this));
              },
            });
          };
        case "object": {
          ...
          if (nestedConfig.enumerable || nestedConfig.external) {
            ...
            return (model, data, lastModel) => {
              ...
              if (resultModel) {
                ...
                Object.defineProperty(model, key, {
                  get() {
                    return get$1(this, key, () => get(defaultValue, id));
                  },
                  enumerable: true,
                });
              } else {
        ...
        for (const data of items) {
          ...
          if (typeof data === "object" && data !== null) {
            ...
            if (dataConfig) {
              ...
              const lastModel =
                modelConfig.enumerable && getEntry(modelConfig, id).value;
          ...
          if (modelConfig.enumerable) {
            ...
            Object.defineProperty(result, key, {
              get() {
                return get$1(this, key, () => get(Model, id));
              },
              enumerable: true,
            });
          }
...
function get(Model, id) {
  ...
  return get$1(config, stringId, () => {
    id = normalizeId(id);

    if (config.contexts) {
      for (const context of config.contexts) {
        get$1(context, context, getCurrentTimestamp);
      }
    }
...
export { configs, store$1 as default, lists, observe };
