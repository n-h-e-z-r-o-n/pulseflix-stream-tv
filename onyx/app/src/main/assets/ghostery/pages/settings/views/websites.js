...
import Options, { MODE_DEFAULT, GLOBAL_PAUSE_ID, MODE_ZAP } from '../../../store/options.js';
import ElementPickerSelectors from '../../../store/element-picker-selectors.js';
import NoWebsitesSVG from '../assets/no_websites.js';
import __vite_glob_0_27 from './website-details.js';
import __vite_glob_0_28 from './websites-add.js';
...
const __vite_glob_0_29 = {
  [router.connect]: { stack: [__vite_glob_0_27, __vite_glob_0_28] },
  config: store(Config),
      ...
      <settings-page-layout layout="gap:4">
        ...
        <section layout="column gap:4" layout@768px="gap:5">
          <div layout="row items:center gap:2">
            ...
            <ui-button>
              <a href="${router.url(__vite_glob_0_28)}">Add</a>
            </ui-button>
          </div>
          ${websites.length
            ? html`
