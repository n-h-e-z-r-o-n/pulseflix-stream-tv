...
import { FLAG_REDIRECT_PROTECTION } from '../../../npm/@ghostery/config/dist/esm/flags.js';
...
import __vite_glob_0_21 from './regional-filters.js';
import __vite_glob_0_16 from './experimental-filters.js';
import __vite_glob_0_15 from './custom-filters.js';
import __vite_glob_0_22 from './serp.js';
import __vite_glob_0_20 from './redirect-protection.js';
            ...
            >
              ...
              <div layout="column gap:3">
                <div layout="grid:1|max content:center gap">
                  <settings-link href="${router.url(__vite_glob_0_22)}">
                    <ui-icon
                      name="search"
                      color="quaternary"
                ...
                <div layout="grid:1|max content:center gap">
                  <settings-link
                    href="${router.url(__vite_glob_0_15)}"
                ...
                <div layout="grid:1|max content:center gap">
                  <settings-link href="${router.url(__vite_glob_0_16)}">
                    <ui-icon
                      name="flask"
                      color="quaternary"
                      layout="size:3 margin:right"
