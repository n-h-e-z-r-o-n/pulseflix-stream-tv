...
import modeGhosteryScreenshotUrl from '../../../ui/assets/lottie-mode-default.json.js';
import modeZapScreenshotUrl from '../../../ui/assets/lottie-mode-zap.json.js';
      ...
      <settings-page-layout>
        <section layout="column gap:4" layout@768px="gap:5">
          ...
          <div layout="column gap:4">
            ${config.hasFlag(FLAG_MODES) && !managedConfig.disableModes && html`
              <settings-card
                type="content"
                layout="contents"
