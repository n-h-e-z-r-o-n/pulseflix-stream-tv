...
const shortDateFormatter = new Intl.DateTimeFormat(lang, {
  month: 'short',
  day: 'numeric',
});

const longDateFormatter = new Intl.DateTimeFormat(lang, {
  month: 'short',
  day: 'numeric',
  year: 'numeric',
  hour: 'numeric',
...
export { categories, languages, longDateFormatter, regions, shortDateFormatter };
