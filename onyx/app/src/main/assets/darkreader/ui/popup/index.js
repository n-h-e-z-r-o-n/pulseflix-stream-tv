(function () {
    ...
    function ExportTheme({data}) {
        ...
        const listener = ({type, data}, sender) => {
            if (
                ...
                sender.tab &&
                sender.tab.id === tabId &&
                (!sender.contextId || sender.contextId === documentId)
            ) {
    ...
    function getSiteToggleMessage(props) {
        const {data} = props;
        const tab = data.activeTab;
        const isFile = isChromium;
        const isProtected = !tab.isInjected || tab.isProtected;
        return isProtected
        ...
        return m$1(
            ...
            m$1(
                ...
                m$1(Toggle, {
                    ...
                    onChange: (checked) =>
                        actions.changeSettings({changeBrowserTheme: checked})
                }),
                m$1(
                    "p",
                    {class: "more-settings__description"},
            ...
            m$1(
                ...
                m$1(
                    ...
                    m$1(
                        ...
                        m$1("img", {
                            class: "news__qr-code",
                            src: `../assets/images/${"mobile-qr-code-firefox.png"}`
                        })
                    )
                )
            )
