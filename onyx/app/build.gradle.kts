...
android {
    ...
    defaultConfig {
        ...
        buildConfigField( "String", "A_K", "\"https://aniwatch-api-r4uo.vercel.app\"")
        buildConfigField( "String", "APPV_J", "\"https://github.com/n-h-e-z-r-o-n/tv-APP/raw/refs/heads/main/App/version.json\"")
